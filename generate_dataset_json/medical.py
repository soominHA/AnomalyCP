                ...
                for specie in species:
                    ...
                    for idx, img_name in enumerate(img_names):
                        info_img = dict(
                            ...
                            mask_path=f'{cls_dir}/ground_truth/{specie}/{mask_names[idx]}' if is_abnormal else '',
                            cls_name=cls_name,
                            specie_name=species,
...
if __name__ == '__main__':
    runner = MedicalSolver(root='C:/Users/dmkwo/Documents/soo/AnomalyCLIP/data/medical')
    runner.run()