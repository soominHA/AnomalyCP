...
# 캐글 주소: https://www.kaggle.com/datasets/itiresearch/wood-anomaly-detection-one-class-classification?select=wood-anomaly-detection

class WoodSolver(object):
    CLSNAMES = ['wood']

    def __init__(self, root='data/wood'):
        self.root = root
...
if __name__ == '__main__':
    runner = WoodSolver(root='C:/Users/dmkwo/Documents/soo/AnomalyCLIP/data/wood')
    runner.run()
