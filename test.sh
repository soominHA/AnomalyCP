...
for i in "${!depth[@]}";do
    ...
    ## train on the VisA dataset
        ...
        CUDA_VISIBLE_DEVICES=${device} python test.py --dataset data/mvtec \
        --data_path C:/Users/dmkwo/Documents/soo/AnomalyCLIP/data --save_path ./results/${base_dir}/zero_shot \
